"""Sprint 2b: Gemma 4 E2B IT — Third backbone validation.

Run: uv run python scripts/sprint2_gemma4.py --rank 4 --seed 15 --generations 5
     uv run python scripts/sprint2_gemma4.py --rank 16 --seed 15 --generations 5
"""
...
def main():
    ...
    output_dir = Path(__file__).parent.parent / "outputs" / f"gemma4_rank{rank}_seed{seed}"
    output_dir.mkdir(parents=True, exist_ok=True)

    print("=" * 60)
    print(f"SPRINT 2b — GEMMA 4 E2B IT: r={rank}, seed={seed}, {NUM_GENERATIONS} gens")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print(f"GEMMA 4 E2B IT FINAL (r={rank})")

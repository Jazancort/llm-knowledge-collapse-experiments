...
\captionof{figure}{Experimental axes and their corresponding pressure components.}
\label{tab:axes}
...
\captionof{figure}{QLoRA rank sweep on Qwen~2.5~1.5B-Instruct. Retention is reported at
...
\captionof{figure}{QLoRA rank sweep on Gemma~3~1B~IT. Boundary ranks ($r=4$ and $r=16$)
...
\captionof{figure}{FFT learning-rate sweep on Qwen~2.5~1.5B (seed~15, Gen3). Perturbation
...
\begin{table}[width=.95\linewidth,cols=5,pos=htbp]
\captionof{figure}{Synthetic-exposure interventions on Qwen $r=256$. C3 is evaluated with

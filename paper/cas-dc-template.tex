...
evaluated range, Gen10 retention decreases from 97.4\% at $r=16$ to 79.1\% at
$r=256$, a difference of 18.3 percentage points.
...
$r=16$  & 2.2M  & 10 & 97.4\% (N=3)     & 11.08 & Homeo. \\
...
97.4\% across three seeds). At $r=128$, retention settles at
...
97.4\%, 97.4\%, and 97.4\%. At $r=256$, per-seed Gen10 values are 76.9\%,
78.2\%, and 82.1\%. The ranges do not overlap: the lowest $r=16$ value (97.4\%)
exceeds the highest $r=256$ value (82.1\%) by 15.3 percentage points,

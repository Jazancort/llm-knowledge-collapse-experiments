...
\begin{tabular*}{\tblwidth}{@{} lp{2.2cm}p{3.8cm}@{} }
\toprule
Axis & Variable & Range \\
\midrule
...
\begin{tabular*}{\tblwidth}{@{} lllll@{} }
\toprule
Condition & Gen5 Ret. & $\Delta$ & Tokens & $N$ \\
\midrule
C1 Normal    & 83.3\% (65/78) &          & ${\sim}$57k & 1      \\
C2 Short     & 91.0\% (71/78) & +7.7\,pp & ${\sim}$60k & 1      \\
C3 Filtered  & 92.3\% (mean)  & +9.0\,pp & ${\sim}$54k & 3 \\
C4 Canonical & 88.5\% (69/78) & +5.1\,pp & ${\sim}$52k & 1      \\
C5 Random    & 92.7\% (mean)  & +9.4\,pp & ${\sim}$54k & 3 masks \\
\bottomrule
\end{tabular*}
\end{table}

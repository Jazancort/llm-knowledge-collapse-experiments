...
\subsection{Effective training pressure as a unifying framework}\label{sec:disc_pressure}

% TODO

\subsection{Reconciliation with model-collapse literature}\label{sec:disc_literature}

% TODO

\subsection{Output drift as diagnostic signature}\label{sec:disc_drift}

% TODO

\subsection{Practical implications for recursive pipeline governance}\label{sec:disc_practical}
